...
import { Card, EmptyState, PageHeader, PrimaryButton, SectionHeader, SegmentedControl } from '../components/ui'
...
export function HomePage() {
  ...
  return <section className="home-dashboard">
    <PageHeader eyebrow="PERSONAL FINANCE" title={greeting()} description="Your money, organized simply." />
