...
export function HomePage() {
  ...
  return <section className="home-dashboard">
    <PageHeader eyebrow="PERSONAL FINANCE" title="Good morning Yash" description="Your money, organized simply." action={<div className="dashboard-actions"><IconButton label="Voice input"><Mic size={19} /></IconButton><IconButton label="Search"><Search size={19} /></IconButton></div>} />
